      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <XIcon className="absolute top-4 right-4 w-12 h-12" />
